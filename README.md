About ukpopulation-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ukpopulation-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/nismod/ukpopulation
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5852&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ukpopulation-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ukpopulation` can be installed with `conda`:
...
```
mamba install ukpopulation
```

It is possible to list all of the versions of `ukpopulation` available on your platform with `conda`:
...
```
mamba search ukpopulation --channel conda-forge
```
...
mamba repoquery search ukpopulation --channel conda-forge

# List packages depending on `ukpopulation`:
mamba repoquery whoneeds ukpopulation --channel conda-forge

# List dependencies of `ukpopulation`:
mamba repoquery depends ukpopulation --channel conda-forge
```
